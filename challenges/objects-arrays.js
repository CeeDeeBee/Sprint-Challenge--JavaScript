...
console.log(`The tyrannosaurus weighed ${dino1.weight}`);

// What was the diet of a velociraptor?
console.log(`The velociraptor was ${dino3.diet}`);

// How long was a stegosaurus?
console.log(`The stegosaurus was ${dino2.length} long`);

// What time period did tyrannosaurus live in?
console.log(`The tyrannosaurus lived in the ${dino1.period} period`);
...
*/
const populationTotal = zooAnimals.reduce((acc, currentObj) => {
  return acc += currentObj.population;
}, 0);
